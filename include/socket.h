...
class Socket {
    ...
    public:
         ...
         */
        int Read(t_byte* buffer, size_t size);
         ...
         */
        int Receive(t_byte* buffer, size_t size);
         ...
         */
        int Send(t_byte* buffer, size_t size);
         ...
         * \return  Returns the number of bytes actually sent, or -1 on error (and errno will be set accordingly).
         */
        int Reply(t_byte* buffer, size_t size);
         ...
         * \return  Returns the number of bytes actually received, or -1 on error (and errno will be set accordingly).
         */
        static int readFrom(t_socket socket, t_byte * buffer, size_t size, int timeout) {
            int r;
            struct timeval tv;
         ...
         * \return  Returns the number of bytes actually readed, or -1 on error (and errno will be set accordingly).
         */
        static int readFrom(t_socket socket, t_byte * buffer, size_t size) {
            int r;
         ...
         * \return  Returns the number of bytes actually sent, or -1 on error (and errno will be set accordingly).
         */
        static int sendTo(t_socket socket, t_byte * buffer, size_t size) {
            int r;
